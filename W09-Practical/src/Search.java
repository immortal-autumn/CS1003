...
public class Search {
     ...
     * @param cache
     */
    public Search(String search, String query, String cache) {
        this.search = search;
        this.query = query;
        this.cache = cache;
        search();
...
//                System.out.println(hits.getLength());
    ...
    private void venue(NodeList hits) {
        //body
//        System.out.println(hits.getLength());
...
//        System.out.println(hits.getLength());
     ...
     * @param hits
     */
    private void author(NodeList hits) {
     ...
     * @param secondURL
     */
    private void calculateDetails(String secondURL) {
